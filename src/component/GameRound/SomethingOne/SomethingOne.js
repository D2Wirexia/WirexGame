...
const SomethingOne = (props) => {
	...
	let imgMess =
		 <div className={s.imgBlockMess}>
			 <img src={props.oneOfTheThree[messCountRound].img[0]} alt="picture1" id="one"
					onClick={() => {
			 ...
			 <img src={props.oneOfTheThree[messCountRound].img[1]} alt="picture2" id="two"
					onClick={() => {
						$('#one').css('border', 'none');
			 ...
			 <img src={props.oneOfTheThree[messCountRound].img[2]} alt="picture3" id="three"
					onClick={() => {
						$('#one').css('border', 'none');
						$('#two').css('border', 'none');
